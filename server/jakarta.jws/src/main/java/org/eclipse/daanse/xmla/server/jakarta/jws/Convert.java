...
import static org.eclipse.daanse.xmla.server.jakarta.jws.CommandConvertor.convertCancel;
import static org.eclipse.daanse.xmla.server.jakarta.jws.CommandConvertor.convertClearCache;
...
import org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.PropertyList;
...
import org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla_rowset.StatementRowXml;
...
public class Convert {
    ...
    private static Row convertDbSchemaCatalogsResponseRow(DbSchemaCatalogsResponseRow apiRow) {
        ...
        apiRow.type()
            .ifPresent(i -> row.setType(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.TypeEnum.fromValue(i.getValue())));
        apiRow.version()
        ...
        apiRow.clientCacheRefreshPolicy()
            .ifPresent(i -> row.setClientCacheRefreshPolicy(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.ClientCacheRefreshPolicyEnum.fromValue(i.getValue())));
    ...
    public static List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.Restriction> convertRestrictionList(List<Restriction> restrictionList) {
    ...
    public static org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.Restriction convertRestriction(Restriction restriction) {
        org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.Restriction r = new org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.Restriction();
    ...
    private static Row convertDiscoverMdSchemaActionsResponseRow(MdSchemaActionsResponseRow apiRow) {
        ...
        apiRow.actionType()
            .ifPresent(i -> row.setActionType(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.ActionTypeEnum.fromValue(i.getValue())));
        ...
        apiRow.invocation()
            .ifPresent(i -> row.setInvocation(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.InvocationEnum.fromValue(i.getValue())));
        return row;
    }
    ...
    private static Row convertDiscoverMdSchemaCubesResponseRow(MdSchemaCubesResponseRow apiRow) {
        ...
        apiRow.cubeType()
            .ifPresent(i -> row.setCubeType(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.CubeTypeEnum.fromValue(i.name())));
        apiRow.cubeGuid()
        ...
        apiRow.cubeSource()
            .ifPresent(i -> row.setCubeSource(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.CubeSourceEnum.fromValue(i.getValue())));
        apiRow.preferredQueryPatterns()
            .ifPresent(i -> row.setPreferredQueryPatterns(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.PreferredQueryPatternsEnum.fromValue(i.getValue())));
    ...
    private static Row convertDiscoverMdSchemaDimensionsResponseRow(MdSchemaDimensionsResponseRow apiRow) {
        ...
        apiRow.dimensionType()
            .ifPresent(i -> row.setDimensionType(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.DimensionTypeEnum.fromValue(i.getValue())));
        ...
        apiRow.dimensionUniqueSetting()
            .ifPresent(i -> row.setDimensionUniqueSetting(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.DimensionUniqueSettingEnum.fromValue(i.getValue())));
    ...
    private static Row convertDiscoverMdSchemaFunctionsResponseRow(MdSchemaFunctionsResponseRow apiRow) {
        ...
        apiRow.origin()
            .ifPresent(i -> row.setOrigin(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.OriginEnum.fromValue(i.getValue())));
        apiRow.interfaceName()
            .ifPresent(i -> row.setInterfaceName(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.InterfaceNameEnum.fromValue(i.name())));
        apiRow.libraryName()
        ...
        apiRow.directQueryPushable()
            .ifPresent(i -> row.setDirectQueryPushable(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.DirectQueryPushableEnum.fromValue(i.getValue())));
    ...
    private static Row convertDiscoverMdSchemaHierarchiesResponseRow(MdSchemaHierarchiesResponseRow apiRow) {
        ...
        apiRow.structure()
            .ifPresent(i -> row.setStructure(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.StructureEnum.fromValue(i.getValue())));
        apiRow.isVirtual()
            .ifPresent(row::setVirtual);
        apiRow.isReadWrite()
            .ifPresent(row::setReadWrite);
        ...
        apiRow.hierarchyOrigin()
            .ifPresent(i -> row.setHierarchyOrigin(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.HierarchyOriginEnum.fromValue(i.getValue())));
        ...
        apiRow.instanceSelection()
            .ifPresent(i -> row.setInstanceSelection(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.InstanceSelectionEnum.fromValue(i.getValue())));
        apiRow.groupingBehavior()
            .ifPresent(i -> row.setGroupingBehavior(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.GroupingBehaviorEnum.fromValue(i.getValue())));
        apiRow.structureType()
            .ifPresent(i -> row.setStructureType(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.StructureTypeEnum.fromValue(i.getValue())));
    ...
    private static Row convertDiscoverDataSourcesResponseRow(DiscoverDataSourcesResponseRow apiRow) {
        ...
        apiRow.providerType()
            .ifPresent(i -> row.setProviderType(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.ProviderTypeEnum.fromValue(i.name())));
        apiRow.authenticationMode()
            .ifPresent(i -> row.setAuthenticationMode(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.AuthenticationModeEnum.fromValue(i.getValue())));
    ...
    private static Row convertDbSchemaColumnsResponseRow(DbSchemaColumnsResponseRow apiRow) {
        ...
        apiRow.columnFlags()
            .ifPresent(i -> row.setColumnFlags(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.ColumnFlagsEnum.fromValue(i.getValue())));
        apiRow.isNullable()
        ...
        apiRow.columnOlapType()
            .ifPresent(i -> row.setColumnOlapType(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.ColumnOlapTypeEnum.fromValue(i.name())));
    ...
    private static Row convertDbSchemaProviderTypesResponseRow(DbSchemaProviderTypesResponseRow apiRow) {
        ...
        apiRow.dataType()
            .ifPresent(i -> row.setDataType(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.LevelDbTypeEnum.fromValue(i.getValue())));
        apiRow.columnSize()
        ...
        apiRow.searchable()
            .ifPresent(i -> row.setSearchable(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.SearchableEnum.fromValue(i.getValue())));
    ...
    private static Row convertMdSchemaLevelsResponseRow(MdSchemaLevelsResponseRow apiRow) {
        ...
        apiRow.levelType()
            .ifPresent(i -> row.setLevelType(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.LevelTypeEnum.fromValue(i.getValue())));
        apiRow.description()
            .ifPresent(row::setDescription);
        apiRow.customRollupSetting()
            .ifPresent(i -> row.setCustomRollupSettings(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.CustomRollupSettingEnum.fromValue(i.getValue())));
        apiRow.levelUniqueSettings()
            .ifPresent(i -> row.setLevelUniqueSettings(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.LevelUniqueSettingsEnum.fromValue(i.getValue())));
        ...
        apiRow.levelOrigin()
            .ifPresent(i -> row.setLevelOrigin(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.LevelOriginEnum.fromValue(i.getValue())));
    ...
    private static Row convertMdSchemaMeasureGroupDimensionsResponseRow(MdSchemaMeasureGroupDimensionsResponseRow apiRow) {
        ...
        apiRow.dimensionCardinality()
            .ifPresent(i -> row.setDimensionCardinality(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.DimensionCardinalityEnum.fromValue(i.name())));
        apiRow.dimensionIsVisible()
            .ifPresent(row::setDimensionIsVisible);
    ...
    private static Row convertMdSchemaMeasuresResponseRow(MdSchemaMeasuresResponseRow apiRow) {
        ...
        apiRow.measureAggregator()
            .ifPresent(i -> row.setMeasureAggregator(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.MeasureAggregatorEnum.fromValue(i.getValue())));
        apiRow.dataType()
            .ifPresent(i -> row.setDataType(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.LevelDbTypeEnum.fromValue(i.getValue())));
        apiRow.numericPrecision()
    ...
    private static Row convertMdSchemaMembersResponseRow(MdSchemaMembersResponseRow apiRow) {
        ...
        apiRow.memberType()
            .ifPresent(i -> row.setMemberType(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.MemberTypeEnum.fromValue(i.getValue())));
        apiRow.memberGuid()
        ...
        apiRow.scope()
            .ifPresent(i -> row.setScope(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.ScopeEnum.fromValue(i.getValue())));
    ...
    private static Row convertMdSchemaPropertiesResponseRow(MdSchemaPropertiesResponseRow apiRow) {
        ...
        apiRow.propertyType()
            .ifPresent(i -> row.setPropertyType(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.PropertyTypeEnum.fromValue(i.getValue())));
        apiRow.propertyName()
        ...
        apiRow.propertyContentType()
            .ifPresent(i -> row.setPropertyContentType(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.PropertyContentTypeEnum.fromValue(i.getValue())));
        ...
        apiRow.propertyOrigin()
            .ifPresent(i -> row.setPropertyOrigin(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.PropertyOriginEnum.fromValue(i.getValue())));
        ...
        apiRow.propertyCardinality()
            .ifPresent(i -> row.setPropertyCardinality(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.PropertyCardinalityEnum.fromValue(i.name())));
        apiRow.mimeType()
    ...
    private static Row convertMdSchemaSetsResponseRow(MdSchemaSetsResponseRow apiRow) {
        ...
        apiRow.setEvaluationContext()
            .ifPresent(i -> row.setSetEvaluationContext(
                org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.SetEvaluationContextEnum.fromValue(i.getValue())));
    ...
    private static Row convertDbSchemaSourceTablesResponseRow(DbSchemaSourceTablesResponseRow apiRow) {
        ...
        row.setTableType(org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.TableTypeEnum.fromValue(apiRow.tableType().getValue()));
    ...
    private static org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla_empty.Emptyresult convertEmptyresult(Emptyresult emptyresult) {
        org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla_empty.Emptyresult result = new org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla_empty.Emptyresult();
