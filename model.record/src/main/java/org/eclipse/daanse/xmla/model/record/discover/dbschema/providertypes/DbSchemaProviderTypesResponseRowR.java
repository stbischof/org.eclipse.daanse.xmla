...
public record DbSchemaProviderTypesResponseRowR(Optional<String> typeName, Optional<LevelDbTypeEnum> dataType,
        Optional<Integer> columnSize, Optional<String> literalPrefix, Optional<String> literalSuffix,
