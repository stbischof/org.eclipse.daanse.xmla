...
class ClientDiscoverTest {
    ...
    void testDataSources() throws Exception {
        ...
        DiscoverDataSourcesRestrictionsR restrictions = new DiscoverDataSourcesRestrictionsR("dataSourceName",
                Optional.of("dataSourceDescription"), Optional.of("url"), Optional.of("dataSourceInfo"), "providerName",
        ...
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover").exist();
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:RequestType").exist();
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:RequestType")
        ...
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:DataSourceName")
                .isEqualTo("dataSourceName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:DataSourceDescription")
                .isEqualTo("dataSourceDescription");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:URL")
                .isEqualTo("url");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:DataSourceInfo")
                .isEqualTo("dataSourceInfo");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:ProviderName")
                .isEqualTo("providerName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:ProviderType")
                .isEqualTo("DMP");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:AuthenticationMode")
                .isEqualTo("Authenticated");
        // Properties
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Properties/msxmla:PropertyList")
                .exist();
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Properties/msxmla:PropertyList/msxmla:DataSourceInfo")
                .isEqualTo("FoodMart");
        xmlAssert
                .valueByXPath(
                        "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Properties/msxmla:PropertyList/msxmla:Content")
    ...
    void testDiscoverEnumerators() throws Exception {
        ...
        List<DiscoverEnumeratorsResponseRow> rows = client.discover().discoverEnumerators(discoverEnumeratorsRequest,
                requestMetaData);
        ...
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:RequestType").exist();
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:RequestType")
                .isEqualTo("DISCOVER_ENUMERATORS");
        // Restrictions
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList")
                .exist();
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:EnumName")
                .isEqualTo("FoodMart");
        // Properties
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Properties/msxmla:PropertyList")
                .exist();
    ...
    void testDiscoverKeywords() throws Exception {
        ...
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:RequestType").exist();
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:RequestType")
                .isEqualTo("DISCOVER_KEYWORDS");
        // Restrictions
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList")
                .exist();
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:Keyword")
                .isEqualTo("Keyword");
        // Properties
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Properties/msxmla:PropertyList")
                .exist();
    ...
    void testDiscoverLiterals() throws Exception {
        ...
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:RequestType").exist();
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:RequestType")
                .isEqualTo("DISCOVER_LITERALS");
        // Restrictions
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList")
                .exist();
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:LiteralName")
    ...
    void testDiscoverProperties() throws Exception {
        ...
        assertThat(r.propertyAccessType()).isEqualTo(AccessEnum.READ);
        ...
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList")
                .exist();
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:PropertyName")
    ...
    void testSchemaRowSets() throws Exception {
        ...
        properties.addProperty(PropertyListElementDefinition.DATA_SOURCE_INFO, "FoodMart");
        properties.addProperty(PropertyListElementDefinition.CONTENT, "SchemaData");
        DiscoverSchemaRowsetsRestrictionsR restrictions = new DiscoverSchemaRowsetsRestrictionsR(
        ...
        List<DiscoverSchemaRowsetsResponseRow> rows = client.discover()
                .discoverSchemaRowsets(discoverSchemaRowsetsRequest, requestMetaData);
        ...
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:RequestType").exist();
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:RequestType")
                .isEqualTo("DISCOVER_SCHEMA_ROWSETS");
        // Restrictions
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList")
                .exist();
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:SchemaName")
    ...
    void testXmlMetaData() throws Exception {
        ...
        properties.addProperty(PropertyListElementDefinition.DATA_SOURCE_INFO, "FoodMart");
        properties.addProperty(PropertyListElementDefinition.CONTENT, "SchemaData");
        DiscoverXmlMetaDataRestrictionsR restrictions = new DiscoverXmlMetaDataRestrictionsR(Optional.of("ObjectType"),
                Optional.of("DatabaseId"), Optional.of("DimensionId"), Optional.of("CubeId"),
                Optional.of("MeasureGroupId"), Optional.of("PartitionId"), Optional.of("PerspectiveId"),
                Optional.of("DimensionPermissionId"), Optional.of("RoleId"), Optional.of("DatabasePermissionId"),
                Optional.of("MiningModelId"), Optional.of("MiningModelPermissionId"), Optional.of("DataSourceId"),
                Optional.of("MiningStructureId"), Optional.of("AggregationDesignId"), Optional.of("TraceId"),
                Optional.of("MiningStructurePermissionId"), Optional.of("CubePermissionId"), Optional.of("AssemblyId"),
                Optional.of("MdxScriptId"), Optional.of("DataSourceViewId"), Optional.of("DataSourcePermissionId"),
        ...
        List<DiscoverXmlMetaDataResponseRow> rows = client.discover().xmlMetaData(discoverXmlMetaDataRequest,
                requestMetaData);
        ...
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:RequestType").exist();
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:RequestType")
                .isEqualTo("DISCOVER_XML_METADATA");
        // Restrictions
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList")
                .exist();
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:DatabaseID")
                .isEqualTo("DatabaseId");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:DimensionID")
                .isEqualTo("DimensionId");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:CubeID")
                .isEqualTo("CubeId");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:MeasureGroupID")
                .isEqualTo("MeasureGroupId");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:PartitionID")
                .isEqualTo("PartitionId");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:PerspectiveID")
                .isEqualTo("PerspectiveId");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:DimensionPermissionID")
                .isEqualTo("DimensionPermissionId");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:RoleID")
                .isEqualTo("RoleId");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:DatabasePermissionID")
                .isEqualTo("DatabasePermissionId");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:MiningModelID")
                .isEqualTo("MiningModelId");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:MiningModelPermissionID")
                .isEqualTo("MiningModelPermissionId");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:DataSourceID")
                .isEqualTo("DataSourceId");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:MiningStructureID")
                .isEqualTo("MiningStructureId");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:AggregationDesignID")
                .isEqualTo("AggregationDesignId");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:TraceID")
                .isEqualTo("TraceId");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:MiningStructurePermissionID")
                .isEqualTo("MiningStructurePermissionId");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:CubePermissionID")
                .isEqualTo("CubePermissionId");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:AssemblyID")
                .isEqualTo("AssemblyId");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:MdxScriptID")
                .isEqualTo("MdxScriptId");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:DataSourceViewID")
                .isEqualTo("DataSourceViewId");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:DataSourcePermissionID")
                .isEqualTo("DataSourcePermissionId");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:ObjectExpansion")
                .isEqualTo("ExpandObject");
    ...
    void testCatalogs() throws Exception {
        ...
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList")
                .exist();
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:CATALOG_NAME")
    ...
    void testColumns() throws Exception {
        ...
        properties.addProperty(PropertyListElementDefinition.DATA_SOURCE_INFO, "FoodMart");
        properties.addProperty(PropertyListElementDefinition.CONTENT, "SchemaData");
        DbSchemaColumnsRestrictionsR restrictions = new DbSchemaColumnsRestrictionsR(Optional.of("TableCatalog"),
                Optional.of("TableSchema"), Optional.of("TableName"), Optional.of("ColumnName"),
        ...
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:RequestType").exist();
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:RequestType")
                .isEqualTo("DBSCHEMA_COLUMNS");
        // Restrictions
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList")
                .exist();
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:TABLE_CATALOG")
                .isEqualTo("TableCatalog");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:TABLE_SCHEMA")
                .isEqualTo("TableSchema");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:TABLE_NAME")
                .isEqualTo("TableName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:COLUMN_NAME")
                .isEqualTo("ColumnName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:COLUMN_OLAP_TYPE")
                .isEqualTo("ATTRIBUTE");
    ...
    void testProviderTypes() throws Exception {
        ...
        List<DbSchemaProviderTypesResponseRow> rows = client.discover()
                .dbSchemaProviderTypes(dbSchemaProviderTypesRequest, requestMetaData);
        ...
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:RequestType").exist();
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:RequestType")
                .isEqualTo("DBSCHEMA_PROVIDER_TYPES");
        // Restrictions
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList")
                .exist();
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:DATA_TYPE")
                .isEqualTo("0");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:BEST_MATCH")
                .isEqualTo("true");
    ...
    void testSchemata() throws Exception {
        ...
        properties.addProperty(PropertyListElementDefinition.DATA_SOURCE_INFO, "FoodMart");
        properties.addProperty(PropertyListElementDefinition.CONTENT, "SchemaData");
        DbSchemaSchemataRestrictionsR restrictions = new DbSchemaSchemataRestrictionsR("CatalogName", "SchemaName",
                "SchemaOwner");
        ...
        xmlAssert.valueByXPath(
                ...
                .isEqualTo("CatalogName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:SCHEMA_NAME")
                .isEqualTo("SchemaName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:SCHEMA_OWNER")
    ...
    void testSourceTables() throws Exception {
        ...
        List<DbSchemaSourceTablesResponseRow> rows = client.discover().dbSchemaSourceTables(dbSchemaSourceTablesRequest,
                requestMetaData);
        ...
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:RequestType").exist();
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:RequestType")
                .isEqualTo("DBSCHEMA_SOURCE_TABLES");
        // Restrictions
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList")
                .exist();
        xmlAssert.valueByXPath(
        ...
        xmlAssert.valueByXPath(
                ...
                .isEqualTo("TableName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:TABLE_TYPE")
                .isEqualTo("TABLE");
    ...
    void testTables() throws Exception {
        ...
        properties.addProperty(PropertyListElementDefinition.DATA_SOURCE_INFO, "FoodMart");
        properties.addProperty(PropertyListElementDefinition.CONTENT, "SchemaData");
        DbSchemaTablesRestrictionsR restrictions = new DbSchemaTablesRestrictionsR(Optional.of("TableCatalog"),
    ...
    void testTablesInfo() throws Exception {
        ...
        properties.addProperty(PropertyListElementDefinition.DATA_SOURCE_INFO, "FoodMart");
        properties.addProperty(PropertyListElementDefinition.CONTENT, "SchemaData");
        DbSchemaTablesInfoRestrictionsR restrictions = new DbSchemaTablesInfoRestrictionsR(Optional.of("CatalogName"),
        ...
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:RequestType").exist();
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:RequestType")
                .isEqualTo("DBSCHEMA_TABLES_INFO");
        // Restrictions
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList")
                .exist();
        xmlAssert.valueByXPath(
    ...
    void testActions() throws Exception {
        ...
        properties.addProperty(PropertyListElementDefinition.DATA_SOURCE_INFO, "FoodMart");
        properties.addProperty(PropertyListElementDefinition.CONTENT, "SchemaData");
        MdSchemaActionsRestrictionsR restrictions = new MdSchemaActionsRestrictionsR(Optional.of("CatalogName"),
                Optional.of("SchemaName"), "CubeName", Optional.of("ActionName"), Optional.of(ActionTypeEnum.URL),
                Optional.of("Coordinate"), CoordinateTypeEnum.CUBE, InvocationEnum.NORMAL_OPERATION,
        ...
        xmlAssert.valueByXPath(
                ...
                .isEqualTo("SchemaName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:CUBE_NAME")
                .isEqualTo("CubeName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:ACTION_NAME")
                .isEqualTo("ActionName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:ACTION_TYPE")
                .isEqualTo("1");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:COORDINATE")
                .isEqualTo("Coordinate");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:COORDINATE_TYPE")
                .isEqualTo("1");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:INVOCATION")
                .isEqualTo("1");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:CUBE_SOURCE")
                .isEqualTo("1");
    ...
    void testCubes() throws Exception {
        ...
        properties.addProperty(PropertyListElementDefinition.DATA_SOURCE_INFO, "FoodMart");
        properties.addProperty(PropertyListElementDefinition.CONTENT, "SchemaData");
        MdSchemaCubesRestrictionsR restrictions = new MdSchemaCubesRestrictionsR("CatalogName",
                Optional.of("SchemaName"), Optional.of("CubeName"), Optional.of(CubeTypeEnum.CUBE),
        ...
        xmlAssert.valueByXPath(
                ...
                .isEqualTo("CubeName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:BASE_CUBE_NAME")
    ...
    void testDimensions() throws Exception {
        ...
        properties.addProperty(PropertyListElementDefinition.DATA_SOURCE_INFO, "FoodMart");
        properties.addProperty(PropertyListElementDefinition.CONTENT, "SchemaData");
        MdSchemaDimensionsRestrictionsR restrictions = new MdSchemaDimensionsRestrictionsR(Optional.of("CatalogName"),
                Optional.of("SchemaName"), Optional.of("CubeName"), Optional.of("DimensionName"),
                Optional.of("DimensionUniqueName"), Optional.of(CubeSourceEnum.CUBE),
        ...
        xmlAssert.valueByXPath(
                ...
                .isEqualTo("CubeName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:DIMENSION_NAME")
                .isEqualTo("DimensionName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:DIMENSION_UNIQUE_NAME")
                .isEqualTo("DimensionUniqueName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:CUBE_SOURCE")
                .isEqualTo("1");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:DIMENSION_VISIBILITY")
                .isEqualTo("1");
    ...
    void testFunctions() throws Exception {
        ...
        properties.addProperty(PropertyListElementDefinition.DATA_SOURCE_INFO, "FoodMart");
        properties.addProperty(PropertyListElementDefinition.CONTENT, "SchemaData");
        MdSchemaFunctionsRestrictionsR restrictions = new MdSchemaFunctionsRestrictionsR(Optional.of("FunctionName"),
        ...
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:RequestType").exist();
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:RequestType")
                .isEqualTo("MDSCHEMA_FUNCTIONS");
        // Restrictions
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList")
                .exist();

        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:ORIGIN")
                .isEqualTo("1");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:INTERFACE_NAME")
                .isEqualTo("FILTER");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:LIBRARY_NAME")
    ...
    void testHierarchies() throws Exception {
        ...
        properties.addProperty(PropertyListElementDefinition.DATA_SOURCE_INFO, "FoodMart");
        properties.addProperty(PropertyListElementDefinition.CONTENT, "SchemaData");
        MdSchemaHierarchiesRestrictionsR restrictions = new MdSchemaHierarchiesRestrictionsR(Optional.of("CatalogName"),
                Optional.of("SchemaName"), Optional.of("CubeName"), Optional.of("DimensionUniqueName"),
                Optional.of("HierarchyName"), Optional.of("HierarchyUniqueName"), Optional.of(10),
        ...
        List<MdSchemaHierarchiesResponseRow> rows = client.discover().mdSchemaHierarchies(mdSchemaHierarchiesRequest,
                requestMetaData);
        ...
        xmlAssert.valueByXPath(
                ...
                .isEqualTo("DimensionUniqueName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:HIERARCHY_NAME")
                .isEqualTo("HierarchyName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:HIERARCHY_UNIQUE_NAME")
                .isEqualTo("HierarchyUniqueName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:HIERARCHY_ORIGIN")
                .isEqualTo(10);
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:CUBE_SOURCE")
                .isEqualTo("1");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:HIERARCHY_VISIBILITY")
                .isEqualTo("1");
    ...
    void testKpis() throws Exception {
        ...
        properties.addProperty(PropertyListElementDefinition.DATA_SOURCE_INFO, "FoodMart");
        properties.addProperty(PropertyListElementDefinition.CONTENT, "SchemaData");
        MdSchemaKpisRestrictionsR restrictions = new MdSchemaKpisRestrictionsR(Optional.of("CatalogName"),
                Optional.of("SchemaName"), Optional.of("CubeName"), Optional.of("KpiName"),
                Optional.of(CubeSourceEnum.CUBE));
        ...
        xmlAssert.valueByXPath(
                ...
                .isEqualTo("CubeName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:KPI_NAME")
                .isEqualTo("KpiName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:CUBE_SOURCE")
                .isEqualTo("1");
    ...
    void testLevels() throws Exception {
        ...
        properties.addProperty(PropertyListElementDefinition.DATA_SOURCE_INFO, "FoodMart");
        properties.addProperty(PropertyListElementDefinition.CONTENT, "SchemaData");
        MdSchemaLevelsRestrictionsR restrictions = new MdSchemaLevelsRestrictionsR(Optional.of("CatalogName"),
                Optional.of("SchemaName"), Optional.of("CubeName"), Optional.of("DimensionUniqueName"),
                Optional.of("HierarchyUniqueName"), Optional.of("LevelName"), Optional.of("LevelUniqueName"),
                Optional.of(LevelOriginEnum.NONE), Optional.of(CubeSourceEnum.CUBE),
                Optional.of(VisibilityEnum.VISIBLE));
        ...
        assertThat(r.description()).isPresent().contains("Description");
        assertThat(r.customRollupSetting()).isPresent()
                .contains(CustomRollupSettingEnum.CUSTOM_ROLLUP_EXPRESSION_EXIST);
        ...
        xmlAssert.valueByXPath(
                ...
                .isEqualTo("HierarchyUniqueName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:LEVEL_NAME")
                .isEqualTo("LevelName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:LEVEL_UNIQUE_NAME")
                .isEqualTo("LevelUniqueName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:CUBE_SOURCE")
                .isEqualTo("1");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:LEVEL_VISIBILITY")
                .isEqualTo("1");
    ...
    void testMeasureGroupDimensions() throws Exception {
        ...
        MdSchemaMeasureGroupDimensionsRestrictionsR restrictions = new MdSchemaMeasureGroupDimensionsRestrictionsR(
                Optional.of("CatalogName"), Optional.of("SchemaName"), Optional.of("CubeName"),
                Optional.of("DimensionUniqueName"), Optional.of("MeasureGroupName"),
                Optional.of(VisibilityEnum.VISIBLE));
        ...
        List<MdSchemaMeasureGroupDimensionsResponseRow> rows = client.discover()
                .mdSchemaMeasureGroupDimensions(mdSchemaMeasureGroupDimensionsRequest, requestMetaData);
        ...
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:RequestType").exist();
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:RequestType")
                .isEqualTo("MDSCHEMA_MEASUREGROUP_DIMENSIONS");
        // Restrictions
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList")
                .exist();
        xmlAssert.valueByXPath(
        ...
        xmlAssert.valueByXPath(
                ...
                .isEqualTo("CubeName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:MEASUREGROUP_NAME")
    ...
    void testMeasureGroups() throws Exception {
        ...
        List<MdSchemaMeasureGroupsResponseRow> rows = client.discover()
                .mdSchemaMeasureGroups(mdSchemaMeasureGroupsRequest, requestMetaData);
        ...
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:RequestType").exist();
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:RequestType")
                .isEqualTo("MDSCHEMA_MEASUREGROUPS");
        // Restrictions
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList")
                .exist();
        xmlAssert.valueByXPath(
    ...
    void testMeasures() throws Exception {
        ...
        xmlAssert.valueByXPath(
                ...
                .isEqualTo("CubeName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:MEASURE_NAME")
                .isEqualTo("MeasureName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:MEASURE_UNIQUE_NAME")
        ...
        xmlAssert.valueByXPath(
                ...
                .isEqualTo("1");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:MEASURE_VISIBILITY")
                .isEqualTo("1");
    ...
    void testMembers() throws Exception {
        ...
        properties.addProperty(PropertyListElementDefinition.DATA_SOURCE_INFO, "FoodMart");
        properties.addProperty(PropertyListElementDefinition.CONTENT, "SchemaData");
        MdSchemaMembersRestrictionsR restrictions = new MdSchemaMembersRestrictionsR(Optional.of("CatalogName"),
                Optional.of("SchemaName"), Optional.of("CubeName"), Optional.of("DimensionUniqueName"),
                Optional.of("HierarchyUniqueName"), Optional.of("LevelUniqueName"), Optional.of(10),
                Optional.of("MemberName"), Optional.of("MemberUniqueName"), Optional.of(MemberTypeEnum.REGULAR_MEMBER),
        ...
        xmlAssert.valueByXPath(
                ...
                .isEqualTo("LevelUniqueName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:LEVEL_NUMBER")
                .isEqualTo("10");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:MEMBER_NAME")
                .isEqualTo("MemberName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:MEMBER_UNIQUE_NAME")
                .isEqualTo("MemberUniqueName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:MEMBER_TYPE")
                .isEqualTo("1");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:MEMBER_CAPTION")
                .isEqualTo("MemberCaption");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:CUBE_SOURCE")
                .isEqualTo("1");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:TREE_OP")
                .isEqualTo("1");
        // Properties
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Properties/msxmla:PropertyList")
                .exist();
    ...
    void testMdProperties() throws Exception {
        ...
        properties.addProperty(PropertyListElementDefinition.DATA_SOURCE_INFO, "FoodMart");
        properties.addProperty(PropertyListElementDefinition.CONTENT, "SchemaData");
        MdSchemaPropertiesRestrictionsR restrictions = new MdSchemaPropertiesRestrictionsR(Optional.of("CatalogName"),
                Optional.of("SchemaName"), Optional.of("CubeName"), Optional.of("DimensionUniqueName"),
                Optional.of("HierarchyUniqueName"), Optional.of("LevelUniqueName"), Optional.of("MemberUniqueName"),
                Optional.of("PropertyName"), Optional.of(PropertyTypeEnum.PROPERTY_MEMBER),
                Optional.of(PropertyContentTypeEnum.REGULAR), Optional.of(PropertyOriginEnum.USER_DEFINED),
                Optional.of(CubeSourceEnum.CUBE), Optional.of(VisibilityEnum.VISIBLE));
        ...
        xmlAssert.valueByXPath(
                ...
                .isEqualTo("MemberUniqueName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:PROPERTY_TYPE")
                .isEqualTo("1");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:PROPERTY_NAME")
                .isEqualTo("PropertyName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:PROPERTY_ORIGIN")
                .isEqualTo("1");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:CUBE_SOURCE")
                .isEqualTo("1");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:PROPERTY_VISIBILITY")
                .isEqualTo("1");
    ...
    void testSets() throws Exception {
        ...
        properties.addProperty(PropertyListElementDefinition.DATA_SOURCE_INFO, "FoodMart");
        properties.addProperty(PropertyListElementDefinition.CONTENT, "SchemaData");
        MdSchemaSetsRestrictionsR restrictions = new MdSchemaSetsRestrictionsR(Optional.of("CatalogName"),
                Optional.of("SchemaName"), Optional.of("CubeName"), Optional.of("SetName"),
                Optional.of(ScopeEnum.GLOBAL), Optional.of("SetCaption"), Optional.of(CubeSourceEnum.CUBE),
        ...
        xmlAssert.valueByXPath(
                ...
                .isEqualTo("CubeName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:SET_NAME")
                .isEqualTo("SetName");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:SCOPE")
                .isEqualTo("1");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/msxmla:Discover/msxmla:Restrictions/msxmla:RestrictionList/msxmla:CUBE_SOURCE")
                .isEqualTo("1");
