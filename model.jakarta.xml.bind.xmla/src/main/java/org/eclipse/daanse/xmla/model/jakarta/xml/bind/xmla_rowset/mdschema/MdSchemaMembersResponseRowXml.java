...
import org.eclipse.daanse.xmla.model.jakarta.xml.bind.enums.MemberTypeEnum;
...
public class MdSchemaMembersResponseRowXml extends AbstractMdSchemaResponseRowXml implements Serializable {
    ...
    /**
     * When true, indicates that a member is a placeholder member for an empty position in a dimension
     * hierarchy; otherwise false. Yes The caption of the member. It is valid only if the MDX
     * Compatibility property has been set to 1.
     */
    ...
    /**
     * The scope of the member. The member can be a session-calculated member or a global-calculated
     * member. The column returns NULL for non- calculated members. This column can have one of the
