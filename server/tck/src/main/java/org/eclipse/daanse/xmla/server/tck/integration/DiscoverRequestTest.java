...
class DiscoverRequestTest {
    ...
    void testDiscoverPropertiesLocaleIdentifier(@InjectService XmlaService xmlaService) {
        ...
        assertThat(request).isNotNull().satisfies(d -> {
            assertThat(d.properties()).isNotNull().satisfies(p -> {
                assertThat(p.localeIdentifier()).isNotNull().isPresent().contains(1033);
                assertThat(p.dataSourceInfo()).isNotNull().isNotPresent();
                assertThat(p.content()).isNotNull().isNotPresent();
    ...
    void testDiscoverPropertiesRestricted(@InjectService XmlaService xmlaService) {
        ...
        assertThat(request).isNotNull().satisfies(d -> {
            assertThat(d.properties()).isNotNull().satisfies(p -> {
                assertThat(p.localeIdentifier()).isNotNull().isPresent().contains(1033);
                assertThat(p.dataSourceInfo()).isNotNull().isPresent().contains(FOOD_MART);
                assertThat(p.content()).isNotNull().isPresent().contains(SCHEMA_DATA);
    ...
    void testDiscoverSchemaRowSets(@InjectService XmlaService xmlaService) {
        ...
        assertThat(request).isNotNull().satisfies(d -> {
            // getRestrictions
            assertThat(d.restrictions()).isNotNull()
                    .satisfies(r -> assertThat(r.schemaName()).isNotNull().isPresent().contains(FOOD_MART));
            // getProperties
            assertThat(d.properties()).isNotNull().satisfies(p -> {
                assertThat(p.localeIdentifier()).isNotNull().isPresent().contains(1033);
                assertThat(p.dataSourceInfo()).isNotNull().isPresent().contains(FOOD_MART);
                assertThat(p.format()).isNotNull().isPresent().contains(TABULAR);
                assertThat(p.catalog()).isNotNull().isPresent().contains(FOOD_MART);
            });
    ...
    void testDiscoverEnumerators(@InjectService XmlaService xmlaService) {
        ...
        assertThat(request).isNotNull().satisfies(d -> {
            // getRestrictions
            assertThat(d.restrictions()).isNotNull()
                    .satisfies(r -> assertThat(r.enumName()).isNotNull().contains(FOOD_MART));
            // getProperties
            assertThat(d.properties()).isNotNull().satisfies(p -> {
    ...
    void testDiscoverKeywords(@InjectService XmlaService xmlaService) {
        ...
        assertThat(request).isNotNull().satisfies(d -> {
            // getRestrictions
            assertThat(d.restrictions()).isNotNull()
                    .satisfies(r -> assertThat(r.keyword()).isNotNull().contains("Keyword1"));
            // getProperties
            assertThat(d.properties()).isNotNull().satisfies(p -> {
                assertThat(p.localeIdentifier()).isNotNull().isNotPresent();
                assertThat(p.dataSourceInfo()).isNotNull().contains(FOOD_MART);
                assertThat(p.format()).isNotNull().isNotPresent();
                assertThat(p.content()).isNotNull().isPresent().contains(SCHEMA_DATA);
            });
        });
    ...
    void testDiscoverLiterals(@InjectService XmlaService xmlaService) {
        ...
        assertThat(request).isNotNull().satisfies(d -> {
            // getRestrictions
            assertThat(d.restrictions()).isNotNull()
                    .satisfies(r -> assertThat(r.literalName()).isNotNull().isPresent().contains("literalName"));
            // getProperties
            assertThat(d.properties()).isNotNull().satisfies(p -> {
                assertThat(p.localeIdentifier()).isNotNull().isNotPresent();
                assertThat(p.dataSourceInfo()).isNotNull().contains(FOOD_MART);
    ...
    void testDbSchemaTables(@InjectService XmlaService xmlaService) {
        ...
        assertThat(request).isNotNull().satisfies(d -> {
            // getRestrictions
            assertThat(d.restrictions()).isNotNull().satisfies(r -> {
                assertThat(r.tableCatalog()).isNotNull().isPresent().contains("tableCatalog");
                assertThat(r.tableName()).isNotNull().isPresent().contains(TABLE_NAME);
                assertThat(r.tableType()).isNotNull().isPresent().contains("tableType");
                assertThat(r.tableSchema()).isNotNull().isPresent().contains("tableSchema");
            });
            // getProperties
            assertThat(d.properties()).isNotNull().satisfies(p -> {
                assertThat(p.localeIdentifier()).isNotNull().isNotPresent();
    ...
    void testMdSchemaActions(@InjectService XmlaService xmlaService) {
        ...
        assertThat(request).isNotNull().satisfies(d -> {
            // getRestrictions
            assertThat(d.restrictions()).isNotNull().satisfies(r -> {
                assertThat(r.catalogName()).isNotNull().isPresent().contains(CATALOG_NAME);
                assertThat(r.schemaName()).isNotNull().isPresent().contains(SCHEMA_NAME);
                assertThat(r.cubeName()).isEqualTo(CUBE_NAME);
                assertThat(r.actionName()).isNotNull().isPresent().contains("actionName");
                assertThat(r.actionType()).isNotNull().isEmpty();
//                                                                                .isPresent()
//                                                                                .contains(ActionTypeEnum.URL);
                assertThat(r.coordinate()).isNotNull().isPresent().contains("coordinate");
                assertThat(r.coordinateType()).isNotNull().isEqualTo(CUBE);
                assertThat(r.invocation()).isNotNull().isEqualTo(NORMAL_OPERATION);
            ...
            assertThat(d.properties()).isNotNull().satisfies(p -> {
                assertThat(p.localeIdentifier()).isNotNull().isNotPresent();
                assertThat(p.dataSourceInfo()).isNotNull().contains(FOOD_MART);
                assertThat(p.catalog()).isNotNull().contains(FOOD_MART);
    ...
    void testMdSchemaCubes(@InjectService XmlaService xmlaService) {
        ...
        assertThat(request).isNotNull().satisfies(d -> {
            ...
            assertThat(d.restrictions()).isNotNull().satisfies(r -> {
                assertThat(r.schemaName()).isNotNull().isPresent().contains(SCHEMA_NAME);
                assertThat(r.cubeName()).isNotNull().isPresent().contains(CUBE_NAME);
                assertThat(r.baseCubeName()).isNotNull().isPresent().contains("baseCubeName");
                assertThat(r.cubeSource()).isNotNull().isPresent().contains(CubeSourceEnum.CUBE);
            });
            // getProperties
            assertThat(d.properties()).isNotNull().satisfies(p -> {
    ...
    void testMdSchemaDimensions(@InjectService XmlaService xmlaService) {
        ...
        assertThat(request).isNotNull().satisfies(d -> {
            ...
            assertThat(d.restrictions()).isNotNull().satisfies(r -> {
                ...
                assertThat(r.schemaName()).isNotNull().isPresent().contains(SCHEMA_NAME);
                assertThat(r.cubeName()).isNotNull().isPresent().contains(CUBE_NAME);
                assertThat(r.dimensionName()).isNotNull().isPresent().contains("dimensionName");
                assertThat(r.dimensionUniqueName()).isNotNull().isPresent().contains(DIMENSION_UNIQUE_NAME);
                assertThat(r.cubeSource()).isNotNull().isPresent().contains(CubeSourceEnum.CUBE);
                assertThat(r.dimensionVisibility()).isNotNull().isPresent().contains(VisibilityEnum.VISIBLE);
            });
            // getProperties
            assertThat(d.properties()).isNotNull().satisfies(p -> {
                assertThat(p.localeIdentifier()).isNotNull().isNotPresent();
    ...
    void testMdSchemaFunctions(@InjectService XmlaService xmlaService) {
        ...
        assertThat(request).isNotNull()
                ...
                .satisfies(d -> {
                    // getRestrictions
                    assertThat(d.restrictions()).isNotNull()
                            .satisfies(r -> assertThat(r.origin()).isNotNull().isNotPresent());
                    // getProperties
                    assertThat(d.properties()).isNotNull().satisfies(p -> {
                        assertThat(p.localeIdentifier()).isNotNull().isNotPresent();
                        assertThat(p.dataSourceInfo()).isNotNull().contains(FOOD_MART);
                        assertThat(p.catalog()).isNotNull().isNotPresent();
                        assertThat(p.format()).isNotNull().isNotPresent();
                        assertThat(p.content()).isNotNull().isPresent().contains(SCHEMA_DATA);
                    });
                });
        ...
        assertThat(request).isNotNull()
                ...
                .satisfies(d -> {
                    ...
                    assertThat(d.restrictions()).isNotNull().satisfies(r -> {
                        ...
                        assertThat(r.cubeName()).isNotNull().isPresent().contains(CUBE_NAME);
                        assertThat(r.dimensionUniqueName()).isNotNull().isPresent().contains(DIMENSION_UNIQUE_NAME);
                        assertThat(r.hierarchyName()).isNotNull().isPresent().contains("hierarchyName");
                        assertThat(r.hierarchyUniqueName()).isNotNull().isPresent().contains(HIERARCHY_UNIQUE_NAME);
                        assertThat(r.hierarchyOrigin()).isNotNull().isPresent().contains(1);
                        assertThat(r.cubeSource()).isNotNull().isPresent().contains(CubeSourceEnum.CUBE);
                        assertThat(r.hierarchyVisibility()).isNotNull().isPresent().contains(VisibilityEnum.VISIBLE);
                    });
                    // getProperties
                    assertThat(d.properties()).isNotNull().satisfies(p -> {
                        assertThat(p.localeIdentifier()).isNotNull().isNotPresent();
        ...
        assertThat(request).isNotNull()
                ...
                .satisfies(d -> {
                    ...
                    assertThat(d.restrictions()).isNotNull().satisfies(r -> {
                        ...
                        assertThat(r.dataSourceName()).isNotNull().isEqualTo("dataSourceName");
                        assertThat(r.dataSourceDescription()).isNotNull().isPresent().contains("dataSourceDescription");
                        assertThat(r.url()).isNotNull().isPresent().contains("url");
                        assertThat(r.dataSourceInfo()).isNotNull().isPresent().contains("dataSourceInfo");
                        assertThat(r.providerName()).isNotNull().isEqualTo("providerName");
                        assertThat(r.providerType()).isNotNull().isPresent().contains(ProviderTypeEnum.DMP);
                        assertThat(r.authenticationMode()).isNotNull().isPresent()
                                .contains(AuthenticationModeEnum.AUTHENTICATED);
                    });
                    // getProperties
                    assertThat(d.properties()).isNotNull().satisfies(p -> {
                        assertThat(p.localeIdentifier()).isNotNull().isNotPresent();
    ...
    void testDiscoverXmlMetadata(@InjectService XmlaService xmlaService) {
        ...
        assertThat(request).isNotNull()
                ...
                .satisfies(d -> {
                    // getRestrictions
                    assertThat(d.restrictions()).isNotNull().satisfies(r -> {
                        assertThat(r.databaseId()).isNotNull().isPresent().contains("databaseId");
                        assertThat(r.dimensionId()).isNotNull().isPresent().contains("dimensionId");
                        assertThat(r.cubeId()).isNotNull().isPresent().contains("cubeId");
                        assertThat(r.measureGroupId()).isNotNull().isPresent().contains("measureGroupId");
                        assertThat(r.partitionId()).isNotNull().isPresent().contains("partitionId");
                        assertThat(r.perspectiveId()).isNotNull().isPresent().contains("perspectiveId");
                        assertThat(r.dimensionPermissionId()).isNotNull().isPresent().contains("dimensionPermissionId");
                        assertThat(r.roleId()).isNotNull().isPresent().contains("roleId");
                        assertThat(r.dataSourcePermissionId()).isNotNull().isPresent()
                                .contains("dataSourcePermissionId");
                        assertThat(r.miningModelId()).isNotNull().isPresent().contains("miningModelId");
                        assertThat(r.miningModelPermissionId()).isNotNull().isPresent()
                                .contains("miningModelPermissionId");
                        assertThat(r.dataSourceId()).isNotNull().isPresent().contains("dataSourceId");
                        assertThat(r.miningStructureId()).isNotNull().isPresent().contains("miningStructureId");
                        assertThat(r.aggregationDesignId()).isNotNull().isPresent().contains("aggregationDesignId");
                        assertThat(r.traceId()).isNotNull().isPresent().contains("traceId");
                        assertThat(r.miningStructurePermissionId()).isNotNull().isPresent()
                                .contains("miningStructurePermissionId");
                        assertThat(r.cubePermissionId()).isNotNull().isPresent().contains("cubePermissionId");
                        assertThat(r.assemblyId()).isNotNull().isPresent().contains("assemblyId");
                        assertThat(r.mdxScriptId()).isNotNull().isPresent().contains("mdxScriptId");
                        assertThat(r.dataSourceViewId()).isNotNull().isPresent().contains("dataSourceViewId");
                        assertThat(r.dataSourcePermissionId()).isNotNull().isPresent()
                                .contains("dataSourcePermissionId");
                        assertThat(r.objectExpansion()).isNotNull().isPresent()
                                .contains(ObjectExpansionEnum.REFERENCE_ONLY);
                    });
                    // getProperties
                    assertThat(d.properties()).isNotNull().satisfies(p -> {
                        assertThat(p.localeIdentifier()).isNotNull().isNotPresent();
        ...
        assertThat(request).isNotNull()
                ...
                .satisfies(d -> {
                    ...
                    assertThat(d.restrictions()).isNotNull().satisfies(r -> {
                        ...
                        assertThat(r.tableSchema()).isNotNull().isPresent().contains("tableSchema");
                        assertThat(r.tableName()).isNotNull().isPresent().contains(TABLE_NAME);
                        assertThat(r.columnName()).isNotNull().isPresent().contains("columnName");
                        assertThat(r.columnOlapType()).isNotNull().isPresent().contains(ColumnOlapTypeEnum.ATTRIBUTE);
                    });
                    // getProperties
                    assertThat(d.properties()).isNotNull().satisfies(p -> {
                        assertThat(p.localeIdentifier()).isNotNull().isNotPresent();
    ...
    void testDbSchemaProviderTypes(@InjectService XmlaService xmlaService) {
        ...
        assertThat(request).isNotNull()
                ...
                .satisfies(d -> {
                    // getRestrictions
                    assertThat(d.restrictions()).isNotNull().satisfies(r -> {
                        assertThat(r.dataType()).isNotNull().isPresent().contains(LevelDbTypeEnum.DBTYPE_DBDATE);
                        assertThat(r.bestMatch()).isNotNull().isPresent().contains(true);
                    });
                    // getProperties
                    assertThat(d.properties()).isNotNull().satisfies(p -> {
                        assertThat(p.localeIdentifier()).isNotNull().isNotPresent();
        ...
        assertThat(request).isNotNull()
                ...
                .satisfies(d -> {
                    ...
                    assertThat(d.restrictions()).isNotNull().satisfies(r -> {
                        ...
                        assertThat(r.dimensionUniqueName()).isNotNull().isPresent().contains(DIMENSION_UNIQUE_NAME);
                        assertThat(r.hierarchyUniqueName()).isNotNull().isPresent().contains(HIERARCHY_UNIQUE_NAME);
                        assertThat(r.levelName()).isNotNull().isPresent().contains("levelName");
                        assertThat(r.levelUniqueName()).isNotNull().isPresent().contains(LEVEL_UNIQUE_NAME);
                        // assertThat(r.cubeSource()).isNotNull()
                        // .isPresent().contains(CubeSourceEnum.CUBE);
                        assertThat(r.levelVisibility()).isNotNull().isPresent().contains(VisibilityEnum.VISIBLE);
                    });
                    // getProperties
                    assertThat(d.properties()).isNotNull().satisfies(p -> {
                        assertThat(p.localeIdentifier()).isNotNull().isNotPresent();
        ...
        assertThat(request).isNotNull()
                ...
                .satisfies(d -> {
                    ...
                    assertThat(d.restrictions()).isNotNull().satisfies(r -> {
                        ...
                        assertThat(r.hierarchyUniqueName()).isNotNull().isPresent().contains(HIERARCHY_UNIQUE_NAME);
                        assertThat(r.levelUniqueName()).isNotNull().isPresent().contains(LEVEL_UNIQUE_NAME);
                        assertThat(r.levelNumber()).isNotNull().isPresent().contains(1);
                        assertThat(r.memberName()).isNotNull().isPresent().contains("memberName");
                        assertThat(r.memberUniqueName()).isNotNull().isPresent().contains("memberUniqueName");
                        assertThat(r.memberType()).isNotNull().isPresent().contains(MemberTypeEnum.REGULAR_MEMBER);
                        assertThat(r.memberCaption()).isNotNull().isPresent().contains("memberCaption");
                        assertThat(r.cubeSource()).isNotNull().isPresent().contains(CubeSourceEnum.CUBE);
                        assertThat(r.treeOp()).isNotNull().isPresent().contains(TreeOpEnum.ALL);
                    });
                    // getProperties
                    assertThat(d.properties()).isNotNull().satisfies(p -> {
                        assertThat(p.localeIdentifier()).isNotNull().isNotPresent();
        ...
        assertThat(request).isNotNull()
                ...
                .satisfies(d -> {
                    ...
                    assertThat(d.restrictions()).isNotNull().satisfies(r -> {
                        ...
                        assertThat(r.levelUniqueName()).isNotNull().isPresent().contains(LEVEL_UNIQUE_NAME);
                        assertThat(r.memberUniqueName()).isNotNull().isPresent().contains("memberUniqueName");
                        assertThat(r.propertyType()).isNotNull().isPresent().contains(PropertyTypeEnum.PROPERTY_MEMBER);
                        assertThat(r.propertyName()).isNotNull().isPresent().contains("propertyName");
                        assertThat(r.propertyOrigin()).isNotNull().isPresent()
                                .contains(PropertyOriginEnum.USER_DEFINED);
                        assertThat(r.cubeSource()).isNotNull().isPresent().contains(CubeSourceEnum.CUBE);
                        assertThat(r.propertyVisibility()).isNotNull().isPresent().contains(VisibilityEnum.VISIBLE);
                    });
                    // getProperties
                    assertThat(d.properties()).isNotNull().satisfies(p -> {
                        assertThat(p.localeIdentifier()).isNotNull().isNotPresent();
        ...
        assertThat(request).isNotNull()
                ...
                .satisfies(d -> {
                    ...
                    assertThat(d.restrictions()).isNotNull().satisfies(r -> {
                        ...
                        assertThat(r.schemaName()).isNotNull().isPresent().contains(SCHEMA_NAME);
                        assertThat(r.cubeName()).isNotNull().isPresent().contains(CUBE_NAME);
                        assertThat(r.setName()).isNotNull().isPresent().contains("setName");
                        assertThat(r.scope()).isNotNull().isPresent().contains(ScopeEnum.GLOBAL);
                        assertThat(r.cubeSource()).isNotNull().isPresent().contains(CubeSourceEnum.CUBE);
                        assertThat(r.hierarchyUniqueName()).isNotNull().isPresent().contains(HIERARCHY_UNIQUE_NAME);
                    });
                    // getProperties
        ...
        assertThat(request).isNotNull()
                ...
                .satisfies(d -> {
                    ...
                    assertThat(d.restrictions()).isNotNull().satisfies(r -> {
                        ...
                        assertThat(r.schemaName()).isNotNull().isPresent().contains(SCHEMA_NAME);
                        assertThat(r.cubeName()).isNotNull().isPresent().contains(CUBE_NAME);
                        assertThat(r.kpiName()).isNotNull().isPresent().contains("kpiName");
                        assertThat(r.cubeSource()).isNotNull().isPresent().contains(CubeSourceEnum.CUBE);
                    });
                    // getProperties
                    assertThat(d.properties()).isNotNull().satisfies(p -> {
