...
class Convertor {
    ...
    static List<DbSchemaTablesInfoResponseRow> convertToDbSchemaTablesInfoResponseRow(SOAPBody b) {
        ...
        return l.stream()
                .map(m -> (DbSchemaTablesInfoResponseRow) new DbSchemaTablesInfoResponseRowR(
                        ...
                        Optional.ofNullable(getLong(m.get(CARDINALITY))), Optional.ofNullable(m.get(DESCRIPTION_UC)),
    ...
    static List<DbSchemaSourceTablesResponseRow> convertToDbSchemaSourceTablesResponseRow(SOAPBody b) {
        List<Map<String, String>> l = getMapValuesList(b);
        return l.stream()
                .map(m -> (DbSchemaSourceTablesResponseRow) new DbSchemaSourceTablesResponseRowR(
                        Optional.ofNullable(m.get(TABLE_CATALOG)), Optional.ofNullable(m.get(TABLE_SCHEMA)),
                        m.get(TABLE_NAME), TableTypeEnum.fromValue(m.get(TABLE_TYPE))))
                .toList();
    }
    ...
    static List<MdSchemaKpisResponseRow> convertToMdSchemaKpisResponseRow(SOAPBody b) {
        List<Map<String, String>> l = getMapValuesList(b);
        return l.stream()
                .map(m -> (MdSchemaKpisResponseRow) new MdSchemaKpisResponseRowR(
                        Optional.ofNullable(m.get(CATALOG_NAME)), Optional.ofNullable(m.get(SCHEMA_NAME)),
                        Optional.ofNullable(m.get(CUBE_NAME)), Optional.ofNullable(m.get(MEASUREGROUP_NAME)),
                        Optional.ofNullable(m.get(KPI_NAME)), Optional.ofNullable(m.get(KPI_CAPTION)),
                        Optional.ofNullable(m.get(KPI_DESCRIPTION)), Optional.ofNullable(m.get(KPI_DISPLAY_FOLDER)),
                        Optional.ofNullable(m.get(KPI_VALUE)), Optional.ofNullable(m.get(KPI_GOAL)),
                        Optional.ofNullable(m.get(KPI_STATUS)), Optional.ofNullable(m.get(KPI_TREND)),
                        Optional.ofNullable(m.get(KPI_STATUS_GRAPHIC)), Optional.ofNullable(m.get(KPI_TREND_GRAPHIC)),
                        Optional.ofNullable(m.get(KPI_WEIGHT)), Optional.ofNullable(m.get(KPI_CURRENT_TIME_MEMBER)),
                        Optional.ofNullable(m.get(KPI_PARENT_KPI_NAME)), Optional.ofNullable(m.get(ANNOTATIONS)),
    ...
    static List<MdSchemaMeasureGroupsResponseRow> convertToMdSchemaMeasureGroupsResponseRow(SOAPBody b) {
        List<Map<String, String>> l = getMapValuesList(b);
        return l.stream()
                .map(m -> (MdSchemaMeasureGroupsResponseRow) new MdSchemaMeasureGroupsResponseRowR(
                        Optional.ofNullable(m.get(CATALOG_NAME)), Optional.ofNullable(m.get(SCHEMA_NAME)),
                        Optional.ofNullable(m.get(CUBE_NAME)), Optional.ofNullable(m.get(MEASUREGROUP_NAME)),
    ...
    static List<MdSchemaSetsResponseRow> convertToMdSchemaSetsResponseRow(SOAPBody b) {
        List<Map<String, String>> l = getMapValuesList(b);
        return l.stream()
                .map(m -> (MdSchemaSetsResponseRow) new MdSchemaSetsResponseRowR(
                        Optional.ofNullable(m.get(CATALOG_NAME)), Optional.ofNullable(m.get(SCHEMA_NAME)),
                        Optional.ofNullable(m.get(CUBE_NAME)), Optional.ofNullable(m.get(SET_NAME)),
                        Optional.ofNullable(ScopeEnum.fromValue(m.get(SCOPE))),
                        Optional.ofNullable(m.get(DESCRIPTION_UC)), Optional.ofNullable(m.get(EXPRESSION_UC)),
                        Optional.ofNullable(m.get(DIMENSIONS_UC)), Optional.ofNullable(m.get(SET_CAPTION)),
    ...
    static List<MdSchemaPropertiesResponseRow> convertToMdSchemaPropertiesResponseRow(SOAPBody b) {
        List<Map<String, String>> l = getMapValuesList(b);
        return l.stream()
                .map(m -> (MdSchemaPropertiesResponseRow) new MdSchemaPropertiesResponseRowR(
                        Optional.ofNullable(m.get(CATALOG_NAME)), Optional.ofNullable(m.get(SCHEMA_NAME)),
                        ...
                        Optional.ofNullable(m.get(LEVEL_UNIQUE_NAME)), Optional.ofNullable(m.get(MEMBER_UNIQUE_NAME)),
                        Optional.ofNullable(PropertyTypeEnum.fromValue(m.get(PROPERTY_TYPE))),
                        Optional.ofNullable(m.get(PROPERTY_NAME)), Optional.ofNullable(m.get(PROPERTY_CAPTION)),
                        ...
                        Optional.ofNullable(getInt(m.get(NUMERIC_SCALE))), Optional.ofNullable(m.get(DESCRIPTION_UC)),
                        Optional.ofNullable(PropertyContentTypeEnum.fromValue(m.get(PROPERTY_CONTENT_TYPE))),
                        Optional.ofNullable(m.get(SQL_COLUMN_NAME)), Optional.ofNullable(getInt(m.get(LANGUAGE_UC))),
    ...
    static List<MdSchemaMembersResponseRow> convertToMdSchemaMembersResponseRow(SOAPBody b) {
        List<Map<String, String>> l = getMapValuesList(b);
        return l.stream().map(m -> (MdSchemaMembersResponseRow) new MdSchemaMembersResponseRowR(
                Optional.ofNullable(m.get(CATALOG_NAME)), Optional.ofNullable(m.get(SCHEMA_NAME)),
                Optional.ofNullable(m.get(CUBE_NAME)), Optional.ofNullable(m.get(DIMENSION_UNIQUE_NAME)),
                Optional.ofNullable(m.get(HIERARCHY_UNIQUE_NAME)), Optional.ofNullable(m.get(LEVEL_UNIQUE_NAME)),
                ...
                Optional.ofNullable(m.get(EXPRESSION_UC)), Optional.ofNullable(m.get(MEMBER_KEY)),
                Optional.ofNullable(getBoolean(m.get(IS_PLACEHOLDERMEMBER))),
                Optional.ofNullable(getBoolean(m.get(IS_DATAMEMBER))),
                Optional.ofNullable(ScopeEnum.fromValue(m.get(SCOPE))))).toList();
    }

    static List<MdSchemaMeasuresResponseRow> convertToMdSchemaMeasuresResponseRow(SOAPBody b) {
        List<Map<String, String>> l = getMapValuesList(b);
        return l.stream().map(m -> (MdSchemaMeasuresResponseRow) new MdSchemaMeasuresResponseRowR(
                Optional.ofNullable(m.get(CATALOG_NAME)), Optional.ofNullable(m.get(SCHEMA_NAME)),
                ...
                Optional.ofNullable(LevelDbTypeEnum.fromValue(m.get(DATA_TYPE))),
                Optional.ofNullable(getInt(m.get(NUMERIC_PRECISION))),
                Optional.ofNullable(getInt(m.get(NUMERIC_SCALE))), Optional.ofNullable(m.get(MEASURE_UNITS)),
                Optional.ofNullable(m.get(DESCRIPTION_UC)), Optional.ofNullable(m.get(EXPRESSION_UC)),
                Optional.ofNullable(getBoolean(m.get(MEASURE_IS_VISIBLE))), Optional.ofNullable(m.get(LEVELS_LIST)),
                Optional.ofNullable(m.get(MEASURE_NAME_SQL_COLUMN_NAME)),
                Optional.ofNullable(m.get(MEASURE_UNQUALIFIED_CAPTION)), Optional.ofNullable(m.get(MEASUREGROUP_NAME)),
                Optional.ofNullable(m.get(MEASURE_DISPLAY_FOLDER)), Optional.ofNullable(m.get(DEFAULT_FORMAT_STRING)),
                Optional.ofNullable(CubeSourceEnum.fromValue(m.get(CUBE_SOURCE))),
                Optional.ofNullable(VisibilityEnum.fromValue(m.get(CUBE_SOURCE))))).toList();
    }
    ...
    static List<MdSchemaMeasureGroupDimensionsResponseRow> convertToMdSchemaMeasureGroupDimensionsResponseRow(
        ...
        if (nodeList != null) {
            for (int i = 0; i < nodeList.getLength(); i++) {
                ...
                result.add(new MdSchemaMeasureGroupDimensionsResponseRowR(Optional.ofNullable(m.get(CATALOG_NAME)),
    ...
    static List<MdSchemaLevelsResponseRow> convertToMdSchemaLevelsResponseRow(SOAPBody b) {
        List<Map<String, String>> l = getMapValuesList(b);
        return l.stream()
                .map(m -> (MdSchemaLevelsResponseRow) new MdSchemaLevelsResponseRowR(
                        Optional.ofNullable(m.get(CATALOG_NAME)), Optional.ofNullable(m.get(SCHEMA_NAME)),
                        Optional.ofNullable(m.get(CUBE_NAME)), Optional.ofNullable(m.get(DIMENSION_UNIQUE_NAME)),
    ...
    static List<DbSchemaSchemataResponseRow> convertToDbSchemaSchemataResponseRow(SOAPBody b) {
        List<Map<String, String>> l = getMapValuesList(b);
        return l.stream().map(m -> (DbSchemaSchemataResponseRow) new DbSchemaSchemataResponseRowR(m.get(CATALOG_NAME),
                m.get(SCHEMA_NAME), m.get(SCHEMA_OWNER))).toList();
    }

    static List<DbSchemaProviderTypesResponseRow> convertToDbSchemaProviderTypesResponseRow(SOAPBody b) {
        List<Map<String, String>> l = getMapValuesList(b);
        return l.stream().map(m -> (DbSchemaProviderTypesResponseRow) new DbSchemaProviderTypesResponseRowR(
                Optional.ofNullable(m.get(TYPE_NAME)), Optional.ofNullable(LevelDbTypeEnum.fromValue(m.get(DATA_TYPE))),
                Optional.ofNullable(getInt(m.get(COLUMN_SIZE))), Optional.ofNullable(m.get(LITERAL_PREFIX)),
                Optional.ofNullable(m.get(LITERAL_SUFFIX)), Optional.ofNullable(m.get(CREATE_PARAMS)),
    ...
    static List<DbSchemaColumnsResponseRow> convertToDbSchemaColumnsResponseRow(SOAPBody b) {
        ...
        return l.stream().map(m -> (DbSchemaColumnsResponseRow) new DbSchemaColumnsResponseRowR(
                ...
                Optional.ofNullable(getBoolean(m.get(IS_NULLABLE))), Optional.ofNullable(getInt(m.get(DATA_TYPE))),
                ...
                Optional.ofNullable(m.get(CHARACTER_SET_CATALOG)), Optional.ofNullable(m.get(CHARACTER_SET_SCHEMA)),
                Optional.ofNullable(m.get(CHARACTER_SET_NAME)), Optional.ofNullable(m.get(COLLATION_CATALOG)),
                Optional.ofNullable(m.get(COLLATION_SCHEMA)), Optional.ofNullable(m.get(COLLATION_NAME)),
                Optional.ofNullable(m.get(DOMAIN_CATALOG)), Optional.ofNullable(m.get(DOMAIN_SCHEMA)),
                Optional.ofNullable(m.get(DOMAIN_NAME)), Optional.ofNullable(m.get(DESCRIPTION_UC)),
                Optional.ofNullable(ColumnOlapTypeEnum.fromValue(m.get(COLUMN_OLAP_TYPE))))).toList();
    }
    ...
    static List<DiscoverDataSourcesResponseRow> convertToDiscoverDataSourcesResponseRow(SOAPBody b) {
        List<Map<String, String>> l = getMapValuesList(b);
        return l.stream()
                .map(m -> (DiscoverDataSourcesResponseRow) new DiscoverDataSourcesResponseRowR(m.get("DataSourceName"),
                        Optional.ofNullable(m.get("DataSourceDescription")), Optional.ofNullable(m.get("URL")),
                        Optional.ofNullable(m.get("DataSourceInfo")), m.get("ProviderName"),
    ...
    static List<DbSchemaTablesResponseRow> convertToDbSchemaTablesResponseRow(SOAPBody b) {
        List<Map<String, String>> l = getMapValuesList(b);
        return l.stream()
                .map(m -> (DbSchemaTablesResponseRow) new DbSchemaTablesResponseRowR(
                        Optional.ofNullable(m.get(TABLE_CATALOG)), Optional.ofNullable(m.get(TABLE_SCHEMA)),
                        Optional.ofNullable(m.get(TABLE_NAME)), Optional.ofNullable(m.get(TABLE_TYPE)),
    ...
    static List<DiscoverEnumeratorsResponseRow> convertToDiscoverEnumeratorsResponseRow(SOAPBody b) {
        List<Map<String, String>> l = getMapValuesList(b);
        return l.stream()
                .map(m -> (DiscoverEnumeratorsResponseRow) new DiscoverEnumeratorsResponseRowR(m.get(ENUM_NAME),
                        Optional.ofNullable(m.get(ENUM_DESCRIPTION)), m.get(ENUM_TYPE), m.get(ELEMENT_NAME),
                        Optional.ofNullable(m.get(ELEMENT_DESCRIPTION)), Optional.ofNullable(m.get(ELEMENT_VALUE))))
                .toList();
    }
    ...
    static List<DiscoverPropertiesResponseRow> convertToDiscoverPropertiesResponseRow(SOAPBody b) {
        List<Map<String, String>> l = getMapValuesList(b);
        return l.stream()
                .map(m -> (DiscoverPropertiesResponseRow) new DiscoverPropertiesResponseRowR(m.get(PROPERTY_NAME1),
                        Optional.ofNullable(m.get("PropertyDescription")), Optional.ofNullable(m.get("PropertyType")),
                        AccessEnum.fromValue(m.get("PropertyAccessType")),
                        Optional.ofNullable(getBoolean(m.get("IsRequired"))), Optional.ofNullable(m.get("Value"))))
                .toList();
    }
    ...
    static List<DiscoverSchemaRowsetsResponseRow> convertToDiscoverSchemaRowsetsResponseRow(SOAPBody b) {
        ...
        if (nodeList != null) {
            for (int i = 0; i < nodeList.getLength(); i++) {
                NodeList nl = nodeList.item(i).getChildNodes();
                Map<String, String> m = getMapValues(nl);
                result.add(new DiscoverSchemaRowsetsResponseRowR(m.get(SCHEMA_NAME1),
    ...
    static List<DiscoverKeywordsResponseRow> convertToDiscoverKeywordsResponseRow(SOAPBody b) {
        List<Map<String, String>> l = getMapValuesList(b);
        return l.stream().map(m -> (DiscoverKeywordsResponseRow) new DiscoverKeywordsResponseRowR(m.get(KEYWORD)))
                .toList();
    }
    ...
    static List<MdSchemaHierarchiesResponseRow> convertToMdSchemaHierarchiesResponseRow(SOAPBody b) {
        List<Map<String, String>> l = getMapValuesList(b);
        return l.stream()
                .map(m -> (MdSchemaHierarchiesResponseRow) new MdSchemaHierarchiesResponseRowR(
                        Optional.ofNullable(m.get(CATALOG_NAME)), Optional.ofNullable(m.get(SCHEMA_NAME)),
                        Optional.ofNullable(m.get(CUBE_NAME)), Optional.ofNullable(m.get(DIMENSION_UNIQUE_NAME)),
                        ...
                        Optional.ofNullable(m.get(DEFAULT_MEMBER_UC)), Optional.ofNullable(m.get(ALL_MEMBER)),
                        Optional.ofNullable(m.get(DESCRIPTION_UC)),
    ...
    static List<MdSchemaFunctionsResponseRow> convertToMdSchemaFunctionsResponseRow(SOAPBody b) {
        ...
        if (nodeList != null) {
            for (int i = 0; i < nodeList.getLength(); i++) {
                NodeList nl = nodeList.item(i).getChildNodes();
                Map<String, String> m = getMapValues(nl);
                result.add(new MdSchemaFunctionsResponseRowR(Optional.ofNullable(m.get(FUNCTION_NAME)),
                        Optional.ofNullable(m.get(DESCRIPTION_UC)), m.get(PARAMETER_LIST),
                        ...
                        Optional.ofNullable(m.get(LIBRARY_NAME)), Optional.ofNullable(m.get(DLL_NAME)),
    ...
    static List<MdSchemaDimensionsResponseRow> convertToMdSchemaDimensionsResponseRow(SOAPBody b) {
        ...
        return l.stream().map(m -> (MdSchemaDimensionsResponseRow) new MdSchemaDimensionsResponseRowR(
                ...
                Optional.ofNullable(m.get(DEFAULT_HIERARCHY)), Optional.ofNullable(m.get(DESCRIPTION_UC)),
                Optional.ofNullable(getBoolean(m.get(IS_VIRTUAL))),
                Optional.ofNullable(getBoolean(m.get(IS_READWRITE))),
                Optional.ofNullable(DimensionUniqueSettingEnum.fromValue(m.get(DIMENSION_UNIQUE_SETTINGS))),
                Optional.ofNullable(m.get(DIMENSION_MASTER_NAME)),
                Optional.ofNullable(getBoolean(m.get(DIMENSION_IS_VISIBLE))))).toList();
    }
    ...
    static List<MdSchemaCubesResponseRow> convertToMdSchemaCubesResponseRow(SOAPBody b) {
        ...
        return l.stream().map(m -> (MdSchemaCubesResponseRow) new MdSchemaCubesResponseRowR(m.get(CATALOG_NAME),
                ...
                Optional.ofNullable(m.get(DATA_UPDATED_BY)), Optional.ofNullable(m.get(DESCRIPTION_UC)),
                Optional.ofNullable(getBoolean(m.get(IS_DRILLTHROUGH_ENABLED))),
                Optional.ofNullable(getBoolean(m.get(IS_LINKABLE))),
                Optional.ofNullable(getBoolean(m.get(IS_WRITE_ENABLED))),
                Optional.ofNullable(getBoolean(m.get(IS_SQL_ENABLED))), Optional.ofNullable(m.get(CUBE_CAPTION)),
    ...
    static List<DbSchemaCatalogsResponseRow> convertToDbSchemaCatalogsResponseRow(SOAPBody b) {
        List<Map<String, String>> l = getMapValuesList(b);
        return l.stream()
                .map(m -> (DbSchemaCatalogsResponseRow) new DbSchemaCatalogsResponseRowR(
                        Optional.ofNullable(m.get(CATALOG_NAME)), Optional.ofNullable(m.get(DESCRIPTION_UC)),
                        Optional.ofNullable(m.get(ROLES)), Optional.ofNullable(getLocalDateTime(m.get(DATE_MODIFIED))),
                        Optional.ofNullable(getInt(m.get(COMPATIBILITY_LEVEL))),
                        Optional.ofNullable(TypeEnum.fromValue(m.get(TYPE))),
                        Optional.ofNullable(getInt(m.get(VERSION))), Optional.ofNullable(m.get(DATABASE_ID)),
    ...
    static StatementResponse convertToStatementResponse(SOAPBody soapBody) {
        ...
        RowSetR rowSet = null;
        if (olapInfo != null || axes != null || cellData != null || exception != null || messages != null) {
            mdDataSet = new MddatasetR(olapInfo, axes, cellData, exception, messages);
        }
    ...
    private static RowSetRowR convertRowSetRow(NodeList nl) {
        ...
        if (nl != null) {
            for (int i = 0; i < nl.getLength(); i++) {
                Node node = nl.item(i);
                list.add(new RowSetRowItemR(node.getNodeName(), node.getTextContent(),
    ...
    private static org.eclipse.daanse.xmla.api.exception.Type getWarningType(Node node) {
        if (node != null) {
            ...
            return new WarningTypeR(location, getInt(getAttribute(nm, "WarningCode")), getAttribute(nm, DESCRIPTION1),
                    getAttribute(nm, "Source"), getAttribute(nm, "HelpFile"));
        }
        return null;
    }
    ...
    private static org.eclipse.daanse.xmla.api.exception.Type getErrorType(Node node) {
        if (node != null) {
            ...
            NamedNodeMap nm = node.getAttributes();
            return new ErrorTypeR(location, callstack, getLong(getAttribute(nm, "ErrorCode")),
                    getAttribute(nm, DESCRIPTION1), getAttribute(nm, "Source"), getAttribute(nm, "HelpFile"));
        }
        return null;
    }
        ...
        if (nl != null) {
            for (int i = 0; i < nl.getLength(); i++) {
                ...
                if (node != null && "Location".equals(node.getNodeName())) {
                    ...
                    return new MessageLocationR(start, end, lineOffset, textLength, sourceObject, dependsOnObject,
                            rowNumber);
                }
            }
    ...
    private static WarningMeasureR getWarningMeasure(NodeList nl) {
        ...
        return new WarningMeasureR(map.get("Cube"), map.get("MeasureGroup"), map.get("MeasureName"));
    }

    private static WarningColumnR getWarningColumn(NodeList nl) {
        Map<String, String> map = getMapValues(nl);
        return new WarningColumnR(map.get("Dimension"), map.get("Attribute"));
    }
        ...
        if (nl != null) {
            ...
            for (int i = 0; i < nl.getLength(); i++) {
                ...
                if (node != null && "Error".equals(node.getNodeName())) {
                    NamedNodeMap nm = node.getAttributes();
                    list.add(
                            new CellTypeErrorR(getLong(getAttribute(nm, "ErrorCode")), getAttribute(nm, DESCRIPTION1)));
                }
            }
            return list;
        }
            ...
            if (nl != null && n.getChildNodes().getLength() > 0) {
                ...
                for (int i = 0; i < nl.getLength(); i++) {
                    ...
                    if ("AxisInfo".equals(node.getNodeName())) {
                        ...
                        list.add(new AxisInfoR(hierarchyInfoList, name));
                    }
                }
        ...
        if (nl != null) {
            ...
            for (int i = 0; i < nl.getLength(); i++) {
                ...
                if (node != null && !node.getNodeName().equals("#text")) {
                    ...
                    list.add(new CellInfoItemR(node.getNodeName(), name, Optional.ofNullable(type)));
                }
            }
            return list;
        }
            ...
            if (nl != null && n.getChildNodes().getLength() > 0) {
                ...
                for (int i = 0; i < nl.getLength(); i++) {
                    ...
                    if ("Cube".equals(node.getNodeName())) {
                        ...
                        list.add(new OlapInfoCubeR(m.get("CubeName"), getInstant(m.get("LastDataUpdate")),
        ...
        if (nl != null) {
            for (int i = 0; i < nl.getLength(); i++) {
                ...
                if (MEASURE_GROUP_DIMENSION.equals(n.getNodeName())) {
                    result.add(new MeasureGroupDimensionR(n.getTextContent()));
                }
            }
        }
        return result;
        ...
        if (nl != null) {
            for (int i = 0; i < nl.getLength(); i++) {
                ...
                if (RESTRICTIONS.equals(n.getNodeName())) {
                    Map<String, String> m = getMapValues(n.getChildNodes());
                    result.add(new RestrictionR(m.get(NAME_LC), m.get(TYPE_LC)));
                }
            }
        }
        return result;
