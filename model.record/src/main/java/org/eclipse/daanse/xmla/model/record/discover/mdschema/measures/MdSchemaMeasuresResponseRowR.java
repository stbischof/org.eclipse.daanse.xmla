...
public record MdSchemaMeasuresResponseRowR(Optional<String> catalogName, Optional<String> schemaName,
        ...
        Optional<String> levelsList, Optional<String> measureNameSqlColumnName,
        Optional<String> measureUnqualifiedCaption, Optional<String> measureGroupName,
        Optional<String> measureDisplayFolder, Optional<String> defaultFormatString,
        Optional<CubeSourceEnum> cubeSource, Optional<VisibilityEnum> measureVisibility)
