...
public interface MdSchemaMembersResponseRow {
    ...
    /**
     * @return The number of children that the member has. This can be an estimate.
     */
    Optional<Integer> childrenCardinality();

    /**
     * @return The distance of the member's parent from the root level of the hierarchy. The root level
     *         is zero (0).
     */
    Optional<Integer> parentLevel();

    /**
     * @return The unique name of the member's parent. NULL is returned for any members at the root
     *         level.
     */
    ...
    /**
     * @return The expression for calculations, if the member is of type 4 (Formula).
     */
    Optional<String> expression();

    /**
     * @return The value of the member's key column. Returns NULL if the member has a composite key.
     */
    Optional<String> memberKey();

    /**
     * @return When true, indicates that a member is a placeholder member for an empty position in a
     *         dimension hierarchy; otherwise false. Yes The caption of the member. It is valid only if
     *         the MDX Compatibility property has been set to 1.
     */
    Optional<Boolean> isPlaceHolderMember();

    /**
     * @return When true, indicates that the member is a data member; otherwise false.
     */
    Optional<Boolean> isDataMember();

    /**
     * @return The scope of the member. The member can be a session-calculated member or a
     *         global-calculated member. The column returns NULL for non- calculated members. This
     *         column can have one of the following values: 1 – Global 2 – Session
     */
